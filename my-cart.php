...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item"><button style="border: none;
					outline: none;
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="update" class="btn-upper btn btn-primary checkout-page-button"
...
onmouseup="this.style.transform='scale(1)';">Update</button>
...
<div class="form-group">
 ...
 <div class="form-group">
					  ...
					  <button type="submit" name="shipupdate" class="btn-upper btn btn-primary checkout-page-button"
					  style="background: white;
    color: green;
    padding: 8px 20px;
    border: 2px solid green;
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" style="
    background: black;
    color: white;
    padding: 12px 26px;
...
onmouseout="this.style.background='black';
            this.style.color='white';
            this.style.transform='scale(1)';
            this.style.boxShadow='0 0 12px rgba(0, 255, 0, 0.6)';"
onmousedown="this.style.transform='scale(0.95)';
             this.style.boxShadow='0 0 8px rgba(0, 255, 0, 0.5)';"
onmouseup="this.style.transform='scale(1.1)';
           this.style.boxShadow='0 0 18px rgba(0, 255, 0, 1)';"
>PROCCED TO CHEKOUT</button>
